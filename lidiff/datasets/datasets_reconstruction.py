...
from lidiff.datasets.dataloader.SemanticKITTIReconstruction import ReconstructionKittiSet
from lidiff.utils.collations import SparseSegmentCollation
import warnings

warnings.filterwarnings('ignore')

__all__ = ['ReconstructionKittiDataModule']

class ReconstructionKittiDataModule(LightningDataModule):
    ...
    def train_dataloader(self):
        ...
        data_set = ReconstructionKittiSet(
            ...
            downsampling=self.cfg['data']['downsampling'],
            condition_point_ratio=self.cfg['data']['condition_point_ratio']
            )
    ...
    def test_dataloader(self):
        ...
        data_set = ReconstructionKittiSet(
            ...
            downsampling=self.cfg['data']['downsampling'],
            condition_point_ratio=self.cfg['data']['condition_point_ratio'],
            n_data=self.cfg['data']['num_test_items']
            )
...
dataloaders = {
    'KITTI': ReconstructionKittiDataModule,
}
