...
python lidiff/tools/object_pcd_denoising.py -c $config_cars_reduced -w $weights_cars_reduced -n car_gen_reduced_1_train -t recreate -cls vehicle.car -s train -m 30
echo "Command completed"

echo "Running recreation for cars reduced dataset using condition from val"
python lidiff/tools/object_pcd_denoising.py -c $config_cars_reduced -w $weights_cars_reduced -n car_gen_reduced_1_val -t recreate -cls vehicle.car -s val -m 30
echo "Command completed"
