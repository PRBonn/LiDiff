...
python lidiff/tools/object_pcd_denoising.py -c $config -w $weights -n all_objects_cleaned_aligned_bikes_train_1 -t recreate -cls vehicle.bicycle -s train -e 2
echo "Command completed"

echo "Recreation motos"
python lidiff/tools/object_pcd_denoising.py -c $config -w $weights -n all_objects_cleaned_aligned_motos_train_1 -t recreate -cls vehicle.motorcycle -s train -e 2
echo "Command completed"
